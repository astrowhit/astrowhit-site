...
- **Publications list is complete.** `publications.html` includes all 222 refereed publications plus 15 submitted works, each linked to ADS, organized by year back to 2005.
